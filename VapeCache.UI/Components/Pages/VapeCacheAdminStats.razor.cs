...
/// <summary>
/// Admin stats page code-behind.
/// </summary>
public partial class VapeCacheAdminStats
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="VapeCacheAdminStats"/> class.
    /// </summary>
    /// <param name="admin">Admin orchestrator.</param>
    public VapeCacheAdminStats(VapeCacheAdminOrchestrator admin)
    {
