...
/// <summary>
/// Admin spill diagnostics page code-behind.
/// </summary>
public partial class VapeCacheAdminSpill
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="VapeCacheAdminSpill"/> class.
    /// </summary>
    /// <param name="admin">Admin orchestrator.</param>
    public VapeCacheAdminSpill(VapeCacheAdminOrchestrator admin)
    {
