...
var hostBuilder = Host.CreateDefaultBuilder(args)
    ...
    .ConfigureServices(static (context, services) =>
    {
        ...
        services
            ...
            .Validate(static o => !o.Enabled || !string.Equals((o.Mode ?? "pool").Trim(), "burn", StringComparison.OrdinalIgnoreCase) || o.BurnConnectionsTarget > 0, "RedisStress:BurnConnectionsTarget must be > 0 when Mode=burn.")
